...
import { BookOpenCheck, ChevronDown, Clock, LayoutDashboard, LogOut, Menu } from "lucide-react"
        ...
        <div className="container mx-auto px-4 flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link href="/user/dashboard" className="flex items-center">
              <h1 className="text-xl font-bold bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-transparent bg-clip-text">
                NeoLibrary
              </h1>
            </Link>
          </div>
